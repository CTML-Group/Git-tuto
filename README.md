...
- To make changes you can work both locally or remotely (<a href="https://github.com/">  </a>), if you choose to work locally you will just need to connect to server for a few mins to sync your files to remote server
